...
public class StudentClassRegistration 
{
   public static void main(String args[]) throws Exception 
   {
	  ...
	  // Instatiate screen objects
		  ...
		  screen[COURSE_LIST] = new StudentProfileScreen();
		  screen[REG_STATUS] = new RegistrationStatusScreen();
		  screen[STUDENT_PROFILE] = new GoodByeScren();
	  ...
	  while(true)
	  {
		  ...
		  {
			  ((RegistrationStatusScreen)screen[REG_STATUS]).ShowScreen();
		  }
		  else if (choice == 3)
		  {
			  ((GoodByeScren)screen[STUDENT_PROFILE]).ShowScreen();
		  }
